...
Each retry carries the same ``X-AMC-Delivery-Id``. We keep a bounded LRU
...
_log = structlog.get_logger("amc.receiver.dispatcher")
...
class ChannelDispatcher:
    ...
    def _spawn_worker(self, channel_id: str) -> _ChannelWorker:
        ...
        task = asyncio.create_task(
            ...
            name=f"amc.receiver.channel.{channel_id}",
        )
