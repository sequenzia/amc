...
:mod:`amc.core.schema` (spec §7.3.2 / §7.3.3) along with their indexes and
...
connection at adapter startup by :mod:`amc.core.db`, which is the
...
from amc.core.schema import metadata
