...
from amc.core.schema import messages, senders
...
async def fetch_context(
    ...
    *,
    ...
    Raises :class:`AMCError` with :attr:`ErrorCode.MESSAGE_NOT_FOUND` when the
...
async def get_messages_context(
    ...
    via the global handler in :mod:`amc.core.errors`.
    """
